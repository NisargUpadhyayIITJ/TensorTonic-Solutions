...
<!-- tensortonic:start -->
# Nisarg Upadhyay's TensorTonic Solutions

Verified machine learning implementations completed on [TensorTonic](https://www.tensortonic.com).

<p align="center">
  <img src="https://www.tensortonic.com/api/badge/nisarg_prakash_oct2005.svg" alt="TensorTonic Verified Solutions" width="100%" />
</p>
...
| Maximum Likelihood Estimation | Estimate the maximum-likelihood mean and standard deviation for observations from a normal distribution. | https://www.tensortonic.com/study-plans/math-probability/probstat-mle-normal |
...
| P-Values and Significance | Compute one-sided or two-sided p-values from the requested reference distribution and classify significance thresholds. | https://www.tensortonic.com/study-plans/math-probability/probstat-p-value-analysis |
...
| T-Test (One Sample) | Given raw sample data and a hypothesized mean, perform a one-sample t-test when the population standard deviation is unknown. | https://www.tensortonic.com/study-plans/math-probability/probstat-t-test-one-sample |
| Z-Test (One Sample) | Perform a two-tailed one-sample z-test from a sample mean, hypothesized mean, known deviation, and sample size. | https://www.tensortonic.com/study-plans/math-probability/probstat-z-test-one-sample |
